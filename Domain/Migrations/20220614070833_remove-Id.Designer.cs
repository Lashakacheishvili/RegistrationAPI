...
namespace Domain.Migrations
{
    ...
    [Migration("20220614070833_remove-Id")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Reason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Model.Payment", b =>
                {
                    b.HasOne("Domain.Model.User", "ChildUser")
                        .WithMany()
                    ...
                    b.HasOne("Domain.Model.Reason", "Reason")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Model.Reason", b =>
                {
                    b.HasOne("Domain.Model.User", "Child")
                        .WithMany()
                        .HasForeignKey("ChildId");

                    b.HasOne("Domain.Model.User", "Parrent")
                        .WithMany()
